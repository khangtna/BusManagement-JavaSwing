...
public class QLChuyen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtfBusStop = new javax.swing.JTextField();
        jttTimeBreak = new javax.swing.JTextField();
        ...
        jLabel6.setText("Thời gian nghỉ");
        ...
        jtfBusStop.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jtfBusStop.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtfBusStopKeyTyped(evt);
            }
        });

        jttTimeBreak.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jttTimeBreak.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jttTimeBreakKeyTyped(evt);
            }
        });

        jtfCost.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jtfCost.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtfCostKeyTyped(evt);
            }
        });
        ...
        jtfStartpoint.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jtfBusStop, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(51, 51, 51)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jttTimeBreak, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(36, 36, 36)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jtfCost, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(49, 49, 49)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jtfStartpoint, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfStartpoint, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtfBusStop, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jttTimeBreak, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void showData(){
        try{
            //tableMain.removeAll();
            String[] arr = {"ID Chuyến","Điểm đến","Điểm đi","Thời gian","Số trạm", "Điểm bắt đầu","Thời gian nghỉ","Chi phí"};
    ...
    private void jbtAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAddActionPerformed
        ...
        if(jtfBack.getText().equals("")){
            ...
            return;
        }else if(jtfStartpoint.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Điểm bắt đầu không được rỗng.");
            jtfTime.requestFocus();
            return;
        }else if(jtfBusStop.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Số trạm không được rỗng.");
            jtfTime.requestFocus();
            return;
        }else if(jttTimeBreak.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Thời gian nghỉ không được rỗng.");
            jtfTime.requestFocus();
            return;
        }else if(jtfCost.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Chi phí không được rỗng.");
            jtfTime.requestFocus();
            return;
        }
            ...
            try{
                Connection connection = DBConnection.getConnection();
                String query= "INSERT INTO dbo.ROUTE(go_turn, back_turn, time_travel, start_point,bus_stop_num,time_break,cost)"
                        + "VALUES(?,?,?,?,?,?,?)";
                PreparedStatement ps = connection.prepareStatement(query);
                ...
                ps.setString(4,jtfStartpoint.getText());
                ps.setString(5,jtfBusStop.getText());
                ps.setString(6,jttTimeBreak.getText());
                ps.setString(7,jtfCost.getText());
    ...
    private void tableMainMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMainMouseClicked
        ...
        jtfBusStop.setText(tableMain.getModel().getValueAt(pos, 4).toString());
        jtfStartpoint.setText(tableMain.getModel().getValueAt(pos, 5).toString());
        jttTimeBreak.setText(tableMain.getModel().getValueAt(pos, 6).toString());
        jtfCost.setText(tableMain.getModel().getValueAt(pos, 7).toString());
    ...
    private void jbtFixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtFixActionPerformed
            ...
            try{
                Connection connection = DBConnection.getConnection();
                String query= "UPDATE ROUTE SET go_turn=? , back_turn= ?, time_travel=?, start_point=?,bus_stop_num=?,time_break=?,cost=? WHERE route_id="+data;
                PreparedStatement ps = connection.prepareStatement(query);
                ps.setString(1,jtfBack.getText());
                ps.setString(2,jtfGo.getText());
                ps.setString(3,jtfTime.getText());
...
//                model.setRowCount(0);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        AccountManagement emp= new AccountManagement();
                    emp.setVisible(true);
                    this.dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        BusManagement emp= new BusManagement();
                    emp.setVisible(true);
                    this.dispose();
    ...
    private void jtfBusStopKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfBusStopKeyTyped
        char c = evt.getKeyChar();
        
        if(!Character.isDigit(c)){
            evt.consume();
            JOptionPane.showMessageDialog(null, "Số trạm không hợp lệ!");
        }
    }//GEN-LAST:event_jtfBusStopKeyTyped

    private void jttTimeBreakKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jttTimeBreakKeyTyped
        char c = evt.getKeyChar();
        
        if(!Character.isDigit(c)){
            evt.consume();
            JOptionPane.showMessageDialog(null, "Thời gian nghỉ không hợp lệ!");
        }
    }//GEN-LAST:event_jttTimeBreakKeyTyped

    private void jtfCostKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfCostKeyTyped
        char c = evt.getKeyChar();
    ...
    }//GEN-LAST:event_jtfCostKeyTyped
    ...
    private javax.swing.JTextField jtfBusStop;
    ...
    private javax.swing.JTextField jttTimeBreak;
